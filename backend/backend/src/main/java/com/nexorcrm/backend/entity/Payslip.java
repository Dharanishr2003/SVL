...
public class Payslip {
    ...
    @Column(name = "overtime", nullable = false, precision = 15, scale = 2)
    ...
    public EmployeeSalary getEmployeeSalary() { return employeeSalary; }
    public void setEmployeeSalary(EmployeeSalary employeeSalary) { this.employeeSalary = employeeSalary; }
