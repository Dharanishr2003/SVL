import{j as s,P as o}from"./index-CqZ4x97i.js";import{u as d}from"./useQuery-Bfjsq5M6.js";import{E as n}from"./apiClient-BCYevyJt.js";import{c as m}from"./crmService-gaF1qCWu.js";const t={html:String.raw`<div class="content">
			...
			</div>`};function f(){const{data:i,isLoading:l,error:e,refetch:c}=d({queryKey:["chat"],queryFn:m.getChat,placeholderData:t,keepPreviousData:!0}),a=typeof i?.html=="string"&&i.html.length>0,r=a?i:t;return l&&!a?s.jsx(o,{}):e&&!a?s.jsx(n,{onRetry:c}):s.jsx("div",{dangerouslySetInnerHTML:{__html:r.html}})}export{f as default};
