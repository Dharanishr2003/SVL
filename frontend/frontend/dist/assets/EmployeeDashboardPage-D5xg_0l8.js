import{j as e,P as c}from"./index-CqZ4x97i.js";import{u as n}from"./useQuery-Bfjsq5M6.js";import{E as o}from"./apiClient-BCYevyJt.js";import{d as v}from"./dashboardService-DbOo9wZi.js";const i={html:String.raw`<div class="content">
            ...
            </div>`};function g(){const{data:s,isLoading:d,error:t,refetch:l}=n({queryKey:["employee-dashboard"],queryFn:v.getEmployeeDashboard,placeholderData:i,keepPreviousData:!0}),a=typeof s?.html=="string"&&s.html.length>0,r=a?s:i;return d&&!a?e.jsx(c,{}):t&&!a?e.jsx(o,{onRetry:l}):e.jsx("div",{dangerouslySetInnerHTML:{__html:r.html}})}export{g as default};
