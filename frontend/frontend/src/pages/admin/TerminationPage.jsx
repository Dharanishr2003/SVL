...
export default function TerminationPage() {
  ...
  const filteredRows = useMemo(() => {
    ...
    if (q) {
      result = result.filter((r) =>
        ...
        (r.terminationType || "").toLowerCase().includes(q) ||
  ...
  const handleBulkDelete = async () => {
    ...
    if (window.confirm(`Are you sure you want to delete the selected ${selectedIds.size} terminations?`)) {
      setSaving(true);
      try {
        await Promise.all(Array.from(selectedIds).map((id) => deleteTermination(id)));
        showSuccess(`${selectedIds.size} terminations deleted successfully`);
        setSelectedIds(new Set());
        await load();
      } catch (e) {
        showError("Failed to delete some terminations");
      } finally {
        setSaving(false);
      }
    }
  ...
  const exportCsv = () => {
    ...
    const headers = ["Terminated Employee", "Department", "Termination Type", "Notice Date", "Reason", "Termination Date"];
    ...
    link.href = url;
    link.download = `terminations-${Date.now()}.csv`;
    link.click();
  ...
  const exportExcel = () => {
    ...
    template += `<head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>Terminations</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--></head>`;
    ...
    const link = document.createElement("a");
    link.href = url;
    link.download = `terminations-${Date.now()}.xls`;
    link.click();
    URL.revokeObjectURL(url);
  };
  ...
  const exportPdf = () => {
    ...
    doc.setFontSize(14);
    doc.text("Terminations Export", 40, 40);
    doc.setFontSize(10);
    ...
    doc.save(`terminations-${Date.now()}.pdf`);
  };
    ...
    <>
      <div className="content">
        ...
        <div className="card border-0 shadow-sm p-4 mb-4 bg-white" style={{ borderRadius: 12 }}>
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
              <h2 className="leads-header-title mb-1" style={{ fontSize: "1.4rem", fontWeight: "700", color: "#0f172a" }}>Termination</h2>
              <nav className="mb-0">
                <ol className="breadcrumb mb-0" style={{ fontSize: "0.9rem" }}>
                  ...
                  <li className="breadcrumb-item active" style={{ color: "#0f172a", fontWeight: "500" }}>Termination</li>
                </ol>
              </nav>
            </div>
              ...
              <table className="table table-hover align-middle mb-0">
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={9} className="text-center py-4">No terminations found</td>
                    </tr>
                  ) : (
            ...
            <form onSubmit={handleAdd}>
              <div className="avm-body">
                <div className="row g-3">
                  ...
                  <div className="col-md-12">
                    <div className="avm-field">
                      <label className="avm-label">Termination Date</label>
          ...
          <div className="avm-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
            ...
            <div className="avm-body">
              <p>
                ...
                {deleteTarget?.employeeName ? ` "${deleteTarget.employeeName}"` : " this termination"}
                ?
              </p>
            </div>
            <div className="avm-footer">
      ...
      {activeActionsRow && createPortal(
        ...
        >
          ...
          >
            <i className="ti ti-edit" style={{ fontSize: "1rem", color: "#64748b" }} /> Edit Termination
          </button>
          <button
          ...
          >
            <i className="ti ti-trash" style={{ fontSize: "1rem", color: "#ef4444" }} /> Delete Termination
          </button>
        </div>,
        document.body
      )}
      ...
      {selectedIds.size > 0 && (
        ...
        >
          <div className="d-flex align-items-center gap-2">
            ...
            <span className="fw-medium text-white" style={{ color: "#ffffff" }}>terminations selected</span>
          </div>
          <div className="d-flex align-items-center gap-2">
            <button
