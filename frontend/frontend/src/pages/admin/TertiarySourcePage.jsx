    ...
    <div className="container-fluid content">
      <div className="card border-0 shadow-sm p-4 mb-4 bg-white" style={{ borderRadius: 12 }}>
        <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
          <div>
            <h2 className="leads-header-title mb-1" style={{ fontSize: "1.4rem", fontWeight: "700", color: "#0f172a" }}>Tertiary Lead Source</h2>
            <p className="leads-header-subtitle text-muted mb-0" style={{ fontSize: "0.9rem" }}>
              Configure and manage tertiary lead acquisition sources.
            </p>
          </div>
          <button
          ...
          <div className="leads-controls-bar d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
            <div className="d-flex align-items-center gap-2 p-1 border" style={{ borderRadius: 12, backgroundColor: "#f8fafc", width: "100%", maxWidth: 350 }}>
              ...
              <input
                ...
                placeholder="Search tertiary source..."
            ...
            <table className="table table-hover align-middle leads-table mb-0">
              <thead>
                <tr>
                  ...
                  <th className="text-muted" style={{ fontWeight: "600", fontSize: "0.85rem" }}>Source Name</th>
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content border-0 shadow-lg" style={{ borderRadius: 14 }}>
                ...
                <div className="modal-body p-4">
                  <label className="form-label small fw-semibold text-muted">Source Name</label>
                  <input
        ...
        <>
          ...
          >
            <div className="modal-dialog modal-dialog-centered modal-sm">
              <div className="modal-content border-0 shadow-lg" style={{ borderRadius: 14 }}>
                <div className="modal-header bg-light">
                  <h5 className="modal-title fw-bold" style={{ color: "#334155" }}>Delete Tertiary Source</h5>
                  <button
                    className="btn-close"
