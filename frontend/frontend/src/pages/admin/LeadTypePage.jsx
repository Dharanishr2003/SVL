...
function LeadTypePage() {
  ...
  const filteredRows = useMemo(() => {
    ...
    return ordered.filter((r) => {
      const name = String(getLabel(r) || "").toLowerCase();
    ...
    <div className="container-fluid content">
      <div className="card border-0 shadow-sm p-4 mb-4 bg-white" style={{ borderRadius: 12 }}>
        <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
          <div>
            <h2 className="leads-header-title mb-1" style={{ fontSize: "1.4rem", fontWeight: "700", color: "#0f172a" }}>Lead Type</h2>
            <p className="leads-header-subtitle text-muted mb-0" style={{ fontSize: "0.9rem" }}>
              Configure and manage lead classification types.
            </p>
          </div>
          <button
            ...
            <table className="table table-hover align-middle leads-table mb-0">
              <thead>
                <tr>
                  ...
                  <th className="text-muted" style={{ fontWeight: "600", fontSize: "0.85rem" }}>Lead Type Name</th>
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={3} className="text-center py-4 text-muted">No records found</td>
                  </tr>
                ) : (
                  pagedRows.map((r, i) => (
                    <tr key={r.id}>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <button
                            ...
                            onClick={() => {
                              setEditingRow(r);
                              setFormValue(getLabel(r) === "-" ? "" : getLabel(r));
                              setShowModal(true);
                            }}
                          >
                            Edit
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content border-0 shadow-lg" style={{ borderRadius: 14 }}>
                ...
                <div className="modal-body p-4">
                  <label className="form-label small fw-semibold text-muted">Type Name</label>
                  <input
        ...
        <>
          ...
          >
            <div className="modal-dialog modal-dialog-centered modal-sm">
              <div className="modal-content border-0 shadow-lg" style={{ borderRadius: 14 }}>
                <div className="modal-header bg-light">
                  <h5 className="modal-title fw-bold" style={{ color: "#334155" }}>Delete Lead Type</h5>
                  <button
                    className="btn-close"
